  ...
  return (
    <div>
        ...
        <div className="flex justify-between items-center">
            ...
            <div className="border-2 border-orange-300 rounded-lg px-8 py-2 text-right">
        ...
        <div className="flex justify-around mt-8 space-x-4">
            ...
            <img src="./src/assets/images/claimreward.png" alt="Reward 1" className="mb-4 w-50 h-50" /> {/* Ganti path gambar */}
            <button className="bg-gray-200 py-1 px-4 rounded-full text-sm mb-2">Redeem</button>
            <p>1000 Points</p>
            </div>

            {/* Card 2 */}
            <div className="w-1/3 border rounded-lg p-4 flex flex-col items-center text-center">
            <img src="./src/assets/images/claimreward.png" alt="Reward 2" className="mb-4 w-50 h-50" /> {/* Ganti path gambar */}
            <button className="bg-gray-200 py-1 px-4 rounded-full text-sm mb-2">Redeem</button>
            <p>2000 Points</p>
            </div>
            ...
            {/* Card 3 */}
            <div className="w-1/3 border rounded-lg p-4 flex flex-col items-center text-center">
            <img src="./src/assets/images/claimreward.png" alt="Reward 3" className="mb-4 w-50 h-50" /> {/* Ganti path gambar */}
            <button className="bg-gray-200 py-1 px-4 rounded-full text-sm mb-2">Redeem</button>
            <p>3000 Points</p>
            </div>
        </div>
        ...
        <div className="flex justify-center items-center mt-8 space-x-2">
            <button className="bg-orange-300 text-white w-8 h-8 rounded-full">&lt;</button>
            <button className="bg-orange-300 text-white w-8 h-8 rounded-full">&gt;</button>
        </div>
    </div>
    </div>
